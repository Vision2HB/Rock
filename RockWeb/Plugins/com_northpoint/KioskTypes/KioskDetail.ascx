<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KioskDetail.ascx.cs" Inherits="RockWeb.Plugins.com_northpoint.KioskTypes.KioskDetail" %>
        ...
        <asp:Panel ID="pnlDetails" CssClass="panel panel-block" runat="server" Visible="false">
            ...
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <Rock:DataTextBox ID="tbName" runat="server" SourceTypeName="com_northpoint.KioskTypes.Model.Kiosk, com_northpoint.KioskTypes" PropertyName="Name" Required="true" />
                        </div>
                        <div class="col-md-6">
                            <Rock:DataTextBox ID="tbIPAddress" runat="server" SourceTypeName="com_northpoint.KioskTypes.Model.Kiosk, com_northpoint.KioskTypes" PropertyName="IPAddress" />
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-12">
                            <Rock:DataTextBox CausesValidation="false" ID="tbDescription" runat="server" SourceTypeName="com_northpoint.KioskTypes.Model.Kiosk, com_northpoint.KioskTypes" PropertyName="Description" TextMode="MultiLine" Rows="3" />
                        </div>
                    </div>

                    <Rock:DataDropDownList CausesValidation="false" runat="server" ID="ddlKioskType" Label="Kiosk Type" DataTextField="Name" DataValueField="Id" SourceTypeName="com_northpoint.KioskTypes.Model.Kiosk, com_northpoint.KioskTypes" PropertyName="KioskTypeId"></Rock:DataDropDownList>
