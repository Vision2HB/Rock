<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AttendanceAnalyticsNPM.ascx.cs" Inherits="RockWeb.Plugins.com_northpoint.RoomCheckIn.AttendanceAnalyticsNPM" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3 filter-options">
                            ...
                            <Rock:RockCheckBoxList ID="cblGroupRoleType" runat="server" Label="Group Role Type" Help="The types of group members to display. No Group Record if there is no record associated. Leave blank to not filter." >
                                <asp:ListItem Value="Member" Text="Member"></asp:ListItem>
                                <asp:ListItem Value="Leader" Text="Leader"></asp:ListItem>
                                <asp:ListItem Value="NoRecord" Text="No Group Record"></asp:ListItem>
                            ...
                            <asp:Panel ID="pnlGroups" runat="server" Visible="false" class="js-groups-container">
                                <Rock:NotificationBox ID="nbGroupsWarning" runat="server" NotificationBoxType="Warning" Text="No Groups Found." Visible="false"/>
