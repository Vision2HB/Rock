<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MultiPersonSelect.ascx.cs" Inherits="RockWeb.Plugins.com_northpoint.RoomCheckIn.MultiPersonSelect" %>
...
<asp:UpdatePanel ID="upContent" runat="server">
    <ContentTemplate>
        <asp:HiddenField ID="hfRemoveRelationshipPersonId" runat="server" />
                            ...
                            <div class="control-group checkin-body-container">
                                ...
                                <div class="controls checkin-person-list">
                                    <asp:Repeater ID="rSelection" runat="server">
                                        <ItemTemplate>
                                            <div class="row">
                                                <asp:Panel ID="pnlPersonButton" runat="server" CssClass="col-xs-11">
                                                ...
                                                <asp:Panel ID="pnlRemoveRelationship" runat="server" CssClass="col-xs-1" Visible='<%# Eval("FamilyMember").ToString().Equals("False") %>'>
                                                    <asp:LinkButton ID="lbRemoveRelationship" CssClass="text-center" runat="server" CommandArgument='<%# Eval("Person.Id") %>' CommandName="Remove"><i style="vertical-align: middle;" class="fa fa-times-circle fa-3x"></i></asp:LinkButton>
                                                </asp:Panel>
                                                <asp:Panel ID="pnlChangeButton" runat="server" CssClass="col-xs-9 col-sm-3 col-md-2" Visible="false">
                                                    <asp:LinkButton ID="lbChange" runat="server" CssClass="btn btn-default btn-block" CommandArgument='<%# Eval("Person.Id") %>' CommandName="Change">Change</asp:LinkButton>
                                                </asp:Panel>
                                            </div>
                                        </ItemTemplate>
                                    </asp:Repeater>
        ...
        <Rock:ModalDialog ID="mdlConfirmRemoveRelationship" runat="server" CancelLinkVisible="true" CloseLinkVisible="true" OnSaveClick="mdlConfirmRemoveRelationship_SaveClick" SaveButtonText="Remove" Title="Confirm Remove">
            <Content>
                Are you sure you would like to remove this child from your check in options?
                <Rock:RockLiteral ID="ltRemoveRelationship" runat="server" />
            </Content>
        </Rock:ModalDialog>
