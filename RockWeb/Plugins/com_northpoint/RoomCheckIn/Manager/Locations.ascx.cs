...
namespace RockWeb.Plugins.com_northpoint.RoomCheckIn.Manager
{
    /// <summary>
    /// Block used to view current check-in counts and locations
    /// </summary>
    [DisplayName( "Locations" )]
    [Category( "com_northpoint > Check-in > Manager" )]
                ...
                if ( groupTypeTemplateGuid.HasValue )
                {
                    ...
                    foreach ( var group in groups )
                    {
                        ...
                        if ( childLocationIds.Any() || childGroupIds.Any() )
                        {
                            ...
                            //testing removing the parent group must be in selected groups requirement
                    ...
                    {
                        nbWarning.Text = "The selected check-in type does not have any valid groups or locations.  " + NavData.ToJson();
                        nbWarning.Visible = true;
                        pnlContent.Visible = false;
