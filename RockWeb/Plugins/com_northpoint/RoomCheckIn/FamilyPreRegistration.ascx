<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FamilyPreRegistration.ascx.cs" Inherits="RockWeb.Plugins.com_northpoint.RoomCheckIn.FamilyPreRegistration" %>
<%@ Register Assembly="com_northpoint.RoomCheckIn" Namespace="com_northpoint.RoomCheckIn.Web.UI.Controls" TagPrefix="NPM" %>
            ...
            <div class="panel-body">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <asp:Panel CssClass="col-md-5" runat="server" ID="pnlPlannedDate">
                                ...
                                <Rock:RockDropDownList ID="ddlVisitingEnroll" runat="server" Label="Enroll Family in Small Groups?">
                                    <asp:ListItem Value="Yes" Text="Yes, Enroll My Family" Selected="True" />
                                    <asp:ListItem Value="No" Text="No, Just Visiting" />
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <asp:Panel CssClass="col-sm-6" runat="server" ID="pnlBirthDate1">
                                <Rock:DatePartsPicker ID="dpBirthDate1" runat="server" Label="Birthdate" AllowFutureDates="False" RequireYear="True" ShowOnFocus="false" StartView="decade" />
                                
                            </asp:Panel>
                            <asp:Panel CssClass="col-sm-2" runat="server" ID="pnlGender1">
                                <Rock:RockDropDownList ID="ddlGender1" runat="server" Label="Gender" />
                            </asp:Panel>
                            <asp:Panel CssClass="col-sm-2" runat="server" ID="pnlMaritalStatus1">
                            ...
                            <asp:Panel CssClass="col-sm-5" runat="server" ID="pnlEmail1">
                        ...
                        <div class="adult-2-fields">
                            ...
                            <div class="row">
                                ...
                                <asp:Panel CssClass="col-sm-6 js-Adult2Required" runat="server" ID="pnlBirthDate2">
                                    <Rock:DatePartsPicker ID="dpBirthDate2" runat="server" Label="Birthdate" AllowFutureDates="False" ShowOnFocus="false" StartView="decade" />
                                    
                                </asp:Panel>
                                <asp:Panel CssClass="col-sm-2 js-Adult2Required" runat="server" ID="pnlGender2">
                                    <Rock:RockDropDownList ID="ddlGender2" runat="server" Label="Gender" />
                                </asp:Panel>
                                <asp:Panel CssClass="col-sm-2 js-Adult2Required" runat="server" ID="pnlMaritalStatus2">
                                ...
                                <asp:Panel CssClass="col-sm-5 js-Adult2Required" runat="server" ID="pnlEmail2">
                ...
                <asp:Panel ID="pnlChildren" runat="server" CssClass="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <NPM:PreRegistrationChildrenNPM ID="prChildren" runat="server" OnAddChildClick="prChildren_AddChildClick" />
                    </div>
                </asp:Panel>

                <div class="actions">
                    <asp:LinkButton ID="lbSave" runat="server" Text="Next" CssClass="btn btn-success btn-lg pull-right" OnClick="btnSave_Click" />
                    <asp:LinkButton ID="lbCancel" runat="server" Text="Cancel" CssClass="btn btn-link btn-lg" OnClientClick="JavaScript: window.history.back(1); return false;" CausesValidation="false" />
                </div>
