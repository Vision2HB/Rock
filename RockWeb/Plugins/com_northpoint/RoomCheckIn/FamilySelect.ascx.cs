...
namespace RockWeb.Plugins.com_northpoint.RoomCheckIn
{
    ...
    [TextField( "No Option Message", 
        ...
        order: 7,
        key: "NoOptionMessage" )]
    [BooleanField( "Continue On 0 People",
        description: "Continue to Person Select page, even if no one is elidgable",
        defaultValue: false,
        category: "Text",
        order: 8,
        key: "ContinueOn0People" )]
    public partial class FamilySelect : CheckInBlock
    {
        ...
        {
            var editFamilyBlock = this.RockPage.ControlsOfTypeRecursive<CheckInEditFamilyBlock>().FirstOrDefault();
            var continueOn0People = GetAttributeValue( "ContinueOn0People" ).AsBoolean();
            ...
            Func<bool> doNotProceedCondition = () =>
            {
                ...
                if ( noMatchingFamilies && !continueOn0People )
                {
