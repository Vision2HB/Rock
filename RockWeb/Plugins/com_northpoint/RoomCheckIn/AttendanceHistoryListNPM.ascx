<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AttendanceHistoryListNPM.ascx.cs" Inherits="RockWeb.Plugins.com_northpoint.RoomCheckIn.AttendanceHistoryListNPM" %>
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gHistory" runat="server" DisplayType="Full" AllowSorting="true" EmptyDataText="No Attendance Found" OnRowDataBound="gHistory_RowDataBound" >
                        <Columns>
                            ...
                            <Rock:RockLiteralField ID="lCode" HeaderText="Code" />
                            <Rock:RockLiteralField ID="lNote" HeaderText="Note" />
