<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RestKeyDetail.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Security.RestKeyDetail" %>
            ...
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <Rock:BootstrapButton ID="lbGenerate" runat="server" Text="Generate Key"  CssClass="btn btn-primary btn-controlaligned mt29" OnClick="lbGenerate_Click" />
                            
                        </div>
                        <div class="col-md-4">
                            <Rock:GroupPicker ID="groupPicker" runat="server" Label="Organization"/>
                        </div>
                    </div>
                    <div class="row">
