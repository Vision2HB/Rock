...
namespace RockWeb.Plugins.com_bemaservices.Prayer
{
    ...
    public partial class PrayerRequestListFilterable : RockBlock
    {
        #region Fields

        // Security Role for viewing Private Prayer Requests
        private static readonly string PrivatePrayerSecurityRole = "RSR - Prayer Private Viewer";

        /// <summary>
        /// Holds whether or not the person can view Private Prayer Requests
        /// </summary>
        ...
        /// </summary>
        private bool PrivatePrayerUser = false;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            // Checking to see if user is in Private Prayer Role
            PrivatePrayerUser = CurrentPerson.Members.Where(g => g.Group.Name == PrivatePrayerSecurityRole).Any();
        ...
        private void BindGrid()
        {
            ...
            // Filter out Private prayer requests if user does not have access
            if (!PrivatePrayerUser)
            {
                prayerRequests = prayerRequests.Where(p => p.IsPublic == true);
            }
