<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PrayerRequestListFilterable.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Prayer.PrayerRequestListFilterable" %>
                    ...
                    <div class="grid grid-panel">
                        ...
                        <Rock:Grid ID="gPrayerRequests" runat="server" AllowSorting="true" RowItemText="request" OnRowSelected="gPrayerRequests_Edit" OnRowDataBound="gPrayerRequests_RowDataBound" >
                            <Columns>
                                ...
                                <Rock:RockBoundField DataField="IsPublic" HeaderText="Public" SortExpression="Text" />
