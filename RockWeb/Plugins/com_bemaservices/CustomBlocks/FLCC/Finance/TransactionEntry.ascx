<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionEntry.ascx.cs" Inherits="Rock.Plugins.com_bemaservices.CustomBlocks.FLCC.Finance.TransactionEntry" %>
                            ...
                            <div class="panel panel-default contribution-info">
                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        ...
                                        <!-- BEMA.FE4.Start -->
                                        <Rock:RockCheckBoxList ID="cblPartnerOptions" runat="server" Label="Partner Options" Visible="false" />
                                        <!-- BEMA.FE4.End -->
