<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AccountEntry.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.CustomBlocks.BEMA.Security.AccountEntry" %>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
               ...
               <fieldset>
                ...
                <% /* BEMA.FE1.Start */ %>
                <cc1:Recaptcha ID="Recaptcha1" PublicKey="PublicKey" PrivateKey="PrivateKey" ApiVersion="2" runat="server"/>
                <% /* BEMA.FE1.End */ %>
