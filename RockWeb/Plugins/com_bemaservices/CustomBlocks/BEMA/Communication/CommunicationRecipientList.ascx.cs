 ...
 * 
 * Additional Features:
 * - FE1) Added ability to honor security on communications
 */
namespace RockWeb.Plugins.com_bemaservices.Communication
{
    ...
    /* BEMA.FE1.Start */
    [BooleanField( "Is Communication Security Honored", "Should the security on emails be honored?", false, "BEMA Additional Features", 2, BemaAttributeKey.IsCommunicationSecurityHonored )]
    /* BEMA.FE1.End */
    ...
    public partial class CommunicationRecipientList : RockBlock, ICustomGridColumns
    {
        ...
        {
            public const string IsCommunicationSecurityHonored = "IsCommunicationSecurityHonored";
        }
        ...
        private void BindGrid()
        {
            ...
            {
                qryCommunications = qryCommunications.ToList().Where( c => c.IsAuthorized( Rock.Security.Authorization.VIEW, CurrentPerson ) ).AsQueryable();
            }
            /* BEMA.FE1.End */
