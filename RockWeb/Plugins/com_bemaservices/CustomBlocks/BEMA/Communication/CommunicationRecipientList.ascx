<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CommunicationRecipientList.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Communication.CommunicationRecipientList" %>
