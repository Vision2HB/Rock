<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionEntry.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.CustomBlocks.WUMC.Finance.TransactionEntry" %>
