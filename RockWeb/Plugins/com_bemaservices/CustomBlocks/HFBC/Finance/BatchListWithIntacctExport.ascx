<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BatchListWithIntacctExport.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.CustomBlocks.HFBC.Finance.BatchListWithIntacctExport" %>
