<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ServiceUImporter.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Finance.ServiceUImporter" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-download"></i> ServiceU Import</h1>
            </div>
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlEntry" runat="server" Visible="true" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <Rock:FileUploader ID="fuServiceUFile" runat="server" Label="ServiceU File" Required="true" OnFileUploaded="fuServiceUFile_FileUploaded" />
                        </div>
                        <div class="col-md-6">
                            <Rock:RockTextBox ID ="tbBatchName" runat="server" Required="true" Label="Batch Name" />
                            <Rock:DefinedValuePicker ID="dvpCurrencyType" runat="server" Label="Currency Type" Required="true" Help="The currency type for the transactions." />
                        </div>
                    </div>
