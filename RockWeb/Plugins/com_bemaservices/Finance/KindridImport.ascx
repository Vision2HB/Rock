        ...
        <div class="panel panel-block">
            <div class="panel-heading">
                <h1 class="panel-title">
                    <i class="fa fa-money" aria-hidden="true"> Kindrid Transaction Import Tool</i></h3>
                </h1>
            </div>
                                    ...
                                    <asp:Repeater ID="rTransactions" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# Eval("Name") %></td>
                                                <td>$<%# string.Format("{0:0.00}", Eval("GrossAmount") ) %></td>
                                                <td>$<%# string.Format("{0:0.00}", Eval("NetAmount") ) %></td>
                                                <td>$<%# string.Format("{0:0.00}", Eval("Fee") ) %></td>
