<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationEntry.ascx.cs" Inherits="RockWeb.Plugins.com_simpledonation.Event.RegistrationEntry" %>
        ...
        <asp:Panel ID="pnlPaymentInfo" runat="server" CssClass="well">
            ...
            <asp:PlaceHolder ID="phPills" runat="server">
                <ul class="nav nav-pills">
                    ...
                    <li class="pull-right" runat="server" id="liCoverFeesParent">
