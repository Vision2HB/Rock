...
namespace RockWeb.Plugins.com_simpledonation.Event
{
    ...
    public partial class RegistrationEntry : RockBlock
    {
        ...
        private void RegisterClientScript()
        {
            ...
            /* SimpleDonation.Start */
            RockPage.AddScriptLink( "~/Plugins/com_simpledonation/Event/Assets/Scripts/cover-fee-reg.js" );
            /* SimpleDonation.End */
...
",
        ...
        private void RegisterFeeRates()
        {
            ...
            if ( accountInfo == null )
            {
                accountInfo = _accountService.GetAccountInfo();
                Cache.Insert( accountInfoKey, accountInfo, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes( 10 ) );
            }

#if DEBUG
                        hfPublicKey.Value = accountInfo.PublicKey ?? "pk_test_V7paQomTsPnaZpFZqQYUIl1X";
#else
