...
namespace com.bemaservices.RoomManagement.Attribute
{
    ...
    public class ReservationTypeFieldAttribute : FieldAttribute
    {
        ...
        public ReservationTypeFieldAttribute( string name = "Reservation Type", string description = "", bool required = true, string defaultReservationTypeId = "", string category = "", int order = 0, string key = null, string fieldTypeAssembly = "com.bemaservices.RoomManagement" )
