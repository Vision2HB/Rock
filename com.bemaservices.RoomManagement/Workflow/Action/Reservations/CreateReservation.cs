    ...
    public class CreateReservation : ActionComponent
    {
        ...
        public override bool Execute( RockContext rockContext, WorkflowAction action, Object entity, out List<string> errorMessages )
        {
            ...
            if ( attribute != null )
            {
                ...
                {
                    reservationType = reservationTypeService.Get( action.GetWorklowAttributeValue( reservationTypeAttributeGuid.Value ).AsGuid() );
                }
                ...
                {
                    schedule = new ScheduleService(rockContext).Get( action.GetWorklowAttributeValue( scheduleAttributeGuid.Value ).AsGuid() );
                }
