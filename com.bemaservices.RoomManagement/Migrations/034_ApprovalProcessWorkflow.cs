...
{{ 'Global' | Attribute:'EmailFooter' }}" ); // Special Approval Notification:Start:Send Notification Email:Body
        ...
        private void ApprovalProcess()
        {
            ...
            RockMigrationHelper.AddAttributeQualifier( "680C5D16-3D16-4DC7-811B-92E272332F0C", "ispassword", @"False", "ADAA7D97-3C75-4F3B-A067-55F481490014" ); // Approval Process:Approval State:ispassword
            RockMigrationHelper.AddAttributeQualifier( "680C5D16-3D16-4DC7-811B-92E272332F0C", "maxcharacters", @"", "B47871A4-D987-4452-8EF9-4E8B39353342" ); // Approval Process:Approval State:maxcharacters
            RockMigrationHelper.AddAttributeQualifier( "680C5D16-3D16-4DC7-811B-92E272332F0C", "showcountdown", @"False", "1E500D16-3013-4956-8596-EC0F4F74CFB4" ); // Approval Process:Approval State:showcountdown
            RockMigrationHelper.AddAttributeQualifier( "071BDAC1-6333-47B1-A376-24D97EAA9326", "EnableSelfSelection", @"False", "2965D310-2721-4A6B-B5BC-2DF0362C1AB3" ); // Approval Process:Requester:EnableSelfSelection
            RockMigrationHelper.AddAttributeQualifier( "35AE460C-60EB-4DC5-98E9-B77B7C8A181C", "EnableSelfSelection", @"False", "BBD1186B-0F34-4320-AFAD-E10EF6A4A3C0" ); // Approval Process:Admin Contact:EnableSelfSelection
            RockMigrationHelper.AddAttributeQualifier( "137CB45C-A1EC-4293-A6F6-0DCFDC40A7C8", "EnableSelfSelection", @"False", "99E0E8A3-FFFA-4AE3-8546-EE707ADFE267" ); // Approval Process:Event Contact:EnableSelfSelection
            RockMigrationHelper.AddAttributeQualifier( "B85C25FD-2A6D-4402-9F86-25D9C3179A8E", "datePickerControlType", @"Date Picker", "A22758A5-638C-4B59-8930-374E3E99BC43" ); // Approval Process:Initial Approval Date Time:datePickerControlType
            RockMigrationHelper.AddAttributeQualifier( "B85C25FD-2A6D-4402-9F86-25D9C3179A8E", "displayCurrentOption", @"False", "C8BBBDE3-AA3F-4881-9543-C02140A07DA4" ); // Approval Process:Initial Approval Date Time:displayCurrentOption
            RockMigrationHelper.AddAttributeQualifier( "B85C25FD-2A6D-4402-9F86-25D9C3179A8E", "displayDiff", @"False", "8BDBC5CA-39C0-4612-A847-CF1BD0B7E0C6" ); // Approval Process:Initial Approval Date Time:displayDiff
            RockMigrationHelper.AddAttributeQualifier( "B85C25FD-2A6D-4402-9F86-25D9C3179A8E", "format", @"", "9AC003D9-30F4-4686-8FAC-077EFE50A492" ); // Approval Process:Initial Approval Date Time:format
            RockMigrationHelper.AddAttributeQualifier( "B85C25FD-2A6D-4402-9F86-25D9C3179A8E", "futureYearCount", @"", "1B824F8B-EE00-4E0D-B776-9866C5803D1C" ); // Approval Process:Initial Approval Date Time:futureYearCount
            RockMigrationHelper.AddAttributeQualifier( "A2B592BA-9C64-4FAF-AADD-DF2D12D12989", "datePickerControlType", @"Date Picker", "57DDD311-F31A-4110-9F57-6B5F9D86A25B" ); // Approval Process:Special Approval Date Time:datePickerControlType
            RockMigrationHelper.AddAttributeQualifier( "A2B592BA-9C64-4FAF-AADD-DF2D12D12989", "displayCurrentOption", @"False", "52B6ED9C-F6A0-4C21-83B3-BC2BF256573C" ); // Approval Process:Special Approval Date Time:displayCurrentOption
            RockMigrationHelper.AddAttributeQualifier( "A2B592BA-9C64-4FAF-AADD-DF2D12D12989", "displayDiff", @"False", "48803E89-DA4F-474E-93C2-952732279085" ); // Approval Process:Special Approval Date Time:displayDiff
            RockMigrationHelper.AddAttributeQualifier( "A2B592BA-9C64-4FAF-AADD-DF2D12D12989", "format", @"", "D53EE181-9DC7-4411-8670-FCC15F531E94" ); // Approval Process:Special Approval Date Time:format
            RockMigrationHelper.AddAttributeQualifier( "A2B592BA-9C64-4FAF-AADD-DF2D12D12989", "futureYearCount", @"", "3668545E-4693-4A4A-86F4-6A1B14A2F7C1" ); // Approval Process:Special Approval Date Time:futureYearCount
            RockMigrationHelper.AddAttributeQualifier( "43301CCE-CFB2-4CB0-839D-3B9E9006D159", "datePickerControlType", @"Date Picker", "9CDCE738-1AB0-47B0-BDCA-5D8DBDEF2DE8" ); // Approval Process:Final Approval Date Time:datePickerControlType
            RockMigrationHelper.AddAttributeQualifier( "43301CCE-CFB2-4CB0-839D-3B9E9006D159", "displayCurrentOption", @"False", "AE637F21-B636-44AA-A058-0D684FE38125" ); // Approval Process:Final Approval Date Time:displayCurrentOption
            RockMigrationHelper.AddAttributeQualifier( "43301CCE-CFB2-4CB0-839D-3B9E9006D159", "displayDiff", @"False", "BD137F23-4DB8-4988-912D-D75D8DE1010B" ); // Approval Process:Final Approval Date Time:displayDiff
            RockMigrationHelper.AddAttributeQualifier( "43301CCE-CFB2-4CB0-839D-3B9E9006D159", "format", @"", "5EF42D18-60CC-4DFE-96E5-3E8587B7AE35" ); // Approval Process:Final Approval Date Time:format
            RockMigrationHelper.AddAttributeQualifier( "43301CCE-CFB2-4CB0-839D-3B9E9006D159", "futureYearCount", @"", "1E96F0DC-8EC0-4E55-B88C-56D90C0EEF10" ); // Approval Process:Final Approval Date Time:futureYearCount
            RockMigrationHelper.AddAttributeQualifier( "3A7EC907-D5D4-4DDA-B616-904B17570636", "ispassword", @"False", "0B42609C-3356-4E23-9457-22406E99C618" ); // Approval Process:Groups Notified:ispassword
            RockMigrationHelper.AddAttributeQualifier( "3A7EC907-D5D4-4DDA-B616-904B17570636", "maxcharacters", @"", "FF4CB2DF-1E86-4363-9A1A-7E65A5D43AFE" ); // Approval Process:Groups Notified:maxcharacters
            RockMigrationHelper.AddAttributeQualifier( "3A7EC907-D5D4-4DDA-B616-904B17570636", "showcountdown", @"False", "C82AD841-A73A-4E44-9C1A-1F44EC9BB846" ); // Approval Process:Groups Notified:showcountdown
            RockMigrationHelper.AddAttributeQualifier( "98EF8E62-8094-4799-A7CE-A5D4713E9372", "BooleanControlType", @"0", "C39415CC-5E48-4BF7-9646-1F129811BAC9" ); // Approval Process:Initial Special Approval Reminders Sent:BooleanControlType
            RockMigrationHelper.AddAttributeQualifier( "98EF8E62-8094-4799-A7CE-A5D4713E9372", "falsetext", @"No", "0E2A1223-60A0-4DB5-A0B0-F99CE83473B2" ); // Approval Process:Initial Special Approval Reminders Sent:falsetext
            RockMigrationHelper.AddAttributeQualifier( "98EF8E62-8094-4799-A7CE-A5D4713E9372", "truetext", @"Yes", "B2ACF274-A5A2-430F-B0B6-C88415ED46BB" ); // Approval Process:Initial Special Approval Reminders Sent:truetext
            ...
            RockMigrationHelper.UpdateWorkflowActionType( "7272A2DF-926C-46E1-87A9-DCD4BC992C67", "Send Email to Admin Contact", 0, "66197B01-D1F0-4924-A315-47AD54E030DE", true, false, "", "", 1, "", "27DA6AF4-DFAC-4D72-B068-FB5C5B4BD9A4" ); // Approval Process:Denied:Send Email to Admin Contact
            RockMigrationHelper.UpdateWorkflowActionType( "7272A2DF-926C-46E1-87A9-DCD4BC992C67", "Send Email to Event Contact", 1, "66197B01-D1F0-4924-A315-47AD54E030DE", true, false, "", "", 1, "", "79551640-080B-44F9-A00B-1AFB1A6D3AD7" ); // Approval Process:Denied:Send Email to Event Contact
            RockMigrationHelper.UpdateWorkflowActionType( "7272A2DF-926C-46E1-87A9-DCD4BC992C67", "Complete Workflow", 2, "EEDA4318-F014-4A46-9C76-4C052EF81AA1", true, false, "", "", 1, "", "22043E5A-45F7-41C4-93AF-9308B1222291" ); // Approval Process:Denied:Complete Workflow
