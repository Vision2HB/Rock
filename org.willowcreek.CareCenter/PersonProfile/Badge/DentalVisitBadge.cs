...
namespace org.willowcreek.CareCenter.PersonProfile.Badge
{
    ...
    /// </summary>
    [Description( "Care Center badge to determine the dental status of a person." )]
    [Export( typeof( BadgeComponent ) )]
    [ExportMetadata( "ComponentName", "Care Center Dental Badge" )]
    public class DentalVisitBadge : BadgeComponent
    {
        ...
        {
            var attributeKey = "ApprovedForDental";
            var serviceName = "dental";
            var serviceIcon = "icon-tooth";
            var sericeAreaGuid = SystemGuid.ServiceArea.SERVICEAREA_DENTAL;
