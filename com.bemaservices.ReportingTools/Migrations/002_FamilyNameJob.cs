...
namespace com.bemaservices.ReportingTools
{
    ...
    public class FamilyNameJob : Migration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"1EDAFDED-DFE6-4334-B019-6EECBA89E05A", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Family - Head Of Household", @"", @"HeadOfHousehold", @"", @"", 216, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.FAMILY_HEAD_OF_HOUSEHOLD_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"DD7ED4C0-A9E0-434F-ACFE-BD4F56B043DF", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Family - First Names", @"", @"FamilyFirstNames", @"", @"", 236, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.FAMILY_FIRST_NAMES_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"DD7ED4C0-A9E0-434F-ACFE-BD4F56B043DF", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Family - Last Names", @"", @"FamilyLastNames", @"", @"", 238, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.FAMILY_LAST_NAMES_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"DD7ED4C0-A9E0-434F-ACFE-BD4F56B043DF", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Family - Nick Names", @"", @"FamilyNickNames", @"", @"", 239, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.FAMILY_NICKNAMES_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"DD7ED4C0-A9E0-434F-ACFE-BD4F56B043DF", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Family - Titles", @"", @"FamilyTitles", @"", @"", 240, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.FAMILY_TITLES_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"1EDAFDED-DFE6-4334-B019-6EECBA89E05A", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Giving Unit - Head Of Household", @"", @"HeadOfHousehold", @"", @"", 216, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.GIVINGUNIT_HEAD_OF_HOUSEHOLD_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"DD7ED4C0-A9E0-434F-ACFE-BD4F56B043DF", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Giving Unit - First Names", @"", @"GivingUnitFirstNames", @"", @"", 236, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.GIVINGUNIT_FIRST_NAMES_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"DD7ED4C0-A9E0-434F-ACFE-BD4F56B043DF", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Giving Unit - Last Names", @"", @"GivingUnitLastNames", @"", @"", 238, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.GIVINGUNIT_LAST_NAMES_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"DD7ED4C0-A9E0-434F-ACFE-BD4F56B043DF", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Giving Unit - Nick Names", @"", @"GivingUnitNickNames", @"", @"", 239, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.GIVINGUNIT_NICKNAMES_ATTRIBUTE );
            ...
            RockMigrationHelper.AddOrUpdatePersonAttributeByGuid( @"DD7ED4C0-A9E0-434F-ACFE-BD4F56B043DF", new List<string>( new string[] { com.bemaservices.ReportingTools.SystemGuid.Category.FAMILY_NAMES } ), @"Giving Unit - Titles", @"", @"GivingUnitTitles", @"", @"", 240, @"", com.bemaservices.ReportingTools.SystemGuid.Attribute.GIVINGUNIT_TITLES_ATTRIBUTE );
