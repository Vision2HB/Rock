...
namespace com.bemaservices.PastoralCare.Migrations
{
    ...
    class Pastoral_Pages : Migration
    {
        ...
        {        
            ...
            RockMigrationHelper.UpdateBlockType( "Hospital List", "A summary of all the current hospitalizations that have been reported to Southeast.", "~/Plugins/com_bemaservices/PastoralCare/HospitalList.ascx", "BEMA > Pastoral Care", "230AEE8C-A2B7-465C-93BE-A92F23364082" );
            ...
            RockMigrationHelper.UpdateBlockType( "Nursing Home List", "A summary of all the current nursing home residents that have been reported to Southeast.", "~/Plugins/com_bemaservices/PastoralCare/NursingHomeList.ascx", "BEMA > Pastoral Care", "AE9E0F36-3511-4536-966E-172275C94E06" );
            ...
            RockMigrationHelper.UpdateBlockType( "Homebound List", "A summary of all the current homebound residents that have been reported to Southeast.", "~/Plugins/com_bemaservices/PastoralCare/HomeboundList.ascx", "BEMA > Pastoral Care", "A21E269D-F50B-42C6-882A-126F3D29D6B2" );
            ...
            RockMigrationHelper.UpdateBlockType( "Communion List", "A list of all the pastoral care patients/residents that have been requested communion.", "~/Plugins/com_bemaservices/PastoralCare/CommunionList.ascx", "BEMA > Pastoral Care", "F1991D17-D7A5-46C2-B7D4-C9CC0FAC460E" );
