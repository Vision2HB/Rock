...
namespace Rock.Jobs
{
    /* BEMA Modified Core Block( v11.0)
     * Version Number based off of RockVersion.RockHotFixVersion.BemaFeatureVersion
     *
     * Additional Features
     * - FE1) Added Ability to Add to Step from Data View.  Step will be first non-complete step according to order.
     *        Data view attribute specified as a Step Attribute with key [EntryDataView].
     *        Added Ability to Complete Step From Data View. Step will be first non-complete step according to order.
     *        Data view attribute specified as a Step Attribute with key [CompletedDataView].
     */
    /// <summary>
    /// Automate Steps From Dataviews
    /// </summary>
    [DisplayName ( "BEMA Steps Automation (plugin)" )]
    [Description( "Creates and/or Completes steps for people within a dataview." )]
    ...
    /* BEMA.FE1.Start */
    [AttributeField (Rock.SystemGuid.EntityType.STEP, "Entry Data View Attribute", "Steps Attribute containing the Entry Data View for creating people in the Step.", false, false,
        Category = "BEMA Additional Features", Key = BemaAttributeKey.EntryDataView )]
    /* BEMA.FE1.End */

    [DisallowConcurrentExecution]
    public class BEMAStepsAutomation : IJob
    {
        #region Keys
        ...
        {
            public const string EntryDataView = "EntryDataView";
        }
        #endregion
        /* BEMA.End */
