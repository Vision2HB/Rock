...
namespace com.bemaservices.Workflow.Workflow.Action
{
    ...
    /// </summary>
    [ActionCategory( "BEMA Services > Utility" )]
        ...
        public override bool Execute( RockContext rockContext, WorkflowAction action, Object entity, out List<string> errorMessages )
        {
            ...
            if ( attributeMatrix != null )
            {
                foreach ( AttributeMatrixItem attributeMatrixItem in attributeMatrix.AttributeMatrixItems )
                {
                    ...
                    string attributeKey = attributeMatrixItem.GetAttributeValue( "AttributeKey" ).ResolveMergeFields( mergeFields );
                    string attributeValue = attributeMatrixItem.GetAttributeValue( "Value" ).ResolveMergeFields( mergeFields );
